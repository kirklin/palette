...
const copyColorValue = (hex: string) => {
  copyToClipboard(hex);
};
...
.color-palette__header {
  @apply text-light h-24 p-4 font-semibold rounded-md hover:scale-105 transition-all;
}
...
.color-palette__item {
  @apply h-12 w-full flex justify-between px-5 font-normal items-center hover:scale-105 transition-all;
}
